...
* **resize(width, height, <keep proportions?>)** — resizes an image. Third parameter is optional: true to keep proportions, false to ignore proportions (default to true)
